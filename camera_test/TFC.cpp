...
void TFC_InitLineScanCamera()
{
    ...
    //Set pins for CCD0
    PORTB->PCR[11] = PORT_PCR_MUX(1) | PORT_PCR_DSE_MASK;   //Enable GPIO on on the pin for the CLOCK Signal
    PORTB->PCR[10] = PORT_PCR_MUX(1) | PORT_PCR_DSE_MASK;   //Enable GPIO on on the pin for SI signal
    PORTC->PCR[1] = PORT_PCR_MUX(0); //Make sure AO signal goes to an analog input
